...
# Définir le répertoire de travail pour la construction de l'application
WORKDIR /app
...
# Utiliser une image OpenJDK pour l'exécution de l'application
...
# Exposer le port de l'application (accés à l'app par ce port)
EXPOSE 8082
